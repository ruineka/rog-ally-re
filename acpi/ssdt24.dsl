 ...
 *
 * Disassembly of ssdt24.dat, Fri Jul 21 14:00:00 2023
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00009756 (38742)
 *     Revision         0x02
 *     Checksum         0x14
 *     OEM ID           "AMD"
 *     OEM Table ID     "CPMCMN"
...
DefinitionBlock ("", "SSDT", 2, "AMD", "CPMCMN", 0x00000001)
{
    ...
    OperationRegion (CPNV, SystemMemory, 0x966E8018, 0x00010117)
    ...
    Method (M900, 1, Serialized)
    {
        ...
        If ((Local0 == Zero))
        {
            If ((M085 >= 0x02))
            {
                Local2 = M013 ((M084 + 0x1500), (Local1 * 0x04), Zero, 
                    0x20)
            }
            Else
            {
                Local2 = M013 ((M084 + 0x0100), Local1, 0x07, One)
            }
        }
        ElseIf ((Local0 == One))
        {
